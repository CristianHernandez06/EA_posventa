                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            @error('userid') <span class="text-danger">{{$messages}}</span> @enderror
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            <label>Fecha Iniciar</label>
                            <input type="date" wire:model.lazy="fromDate" class="form-control">
                            @error('fromDate') <span class="text-danger">{{$messages}}</span> @enderror
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            @error('toDate') <span class="text-danger">{{$messages}}</span> @enderror
                        </div>
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        <h5 class="text-white">Ventas totales: ${{number_format($total)}}</h5>
                            ...
                            <tbody>
                                ...
                                @foreach ($sales as $row)
                                    <tr>
                                        ...
                                        <td class="text-center"><h6>${{number_format($row->total)}}</h6></td>
