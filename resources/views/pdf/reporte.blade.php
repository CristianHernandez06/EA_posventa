    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td colspan="2" class="text-center">
                <span style="font-size: 25px; font-weigth: bold;">Sistema EAVentas</span>
            </td>
        </tr>

        <tr>
            <td width=30% style="vertical-align: top; padding-top: 10px; position: relative">
                <img src="{{ asset('assets/img/tecno.png') }}" alt="" class="invoice-logo">
            </td>
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="1" class="text-center">
                    <span><strong>${{number_format($data->sum('total')) }}</strong></span>
                </td>
...
<section class="footer">
    ...
    <table>
        <table cellpadding="0" cellspacing="0"  class="table-items" width="100%">
            <tr>
                <td width="20%">
                    <span>SISTEMA EA VENTAS TECNOAKA.</span>
                </td>
